...
//				ga("send", "pageview", "/#"+section_id);
	...
	*/
	var map_canvas = document.getElementById('map-canvas');
	var myLatlng	= new daum.maps.LatLng(37.568804, 126.987157);
	...
	function imgMove(){ 
	    if(moveWork==false){ 
	      ...
	      if(moveType==0){ 
	         ...
	         // 롤링마지막에 맨처음의 a태그 추가 
	         $(".RollDiv > div").append("<a>" + $(".RollDiv > div > a:first").html()+ "</a>"); 
	         // 맨처음이미지를 왼쪽으로 이동시킨다. 
	      ...
	      // 마지막 a태그의 폭 
	       ...
	       $("<a>"+$(".RollDiv > div > a:last").html()+ "</a>").insertBefore(".RollDiv > div > a:first"); 
